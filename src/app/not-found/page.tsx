  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        <Link href="/">
          <button className="inline-flex items-center gap-2 bg-primary text-primary-foreground rounded-full h-11 px-6 font-semibold text-sm hover:opacity-90 transition">
            <Home className="h-4 w-4" />
            Back to Home
          </button>
        </Link>
        <Link href="/templates">
          <button className="inline-flex items-center gap-2 border border-border bg-background rounded-full h-11 px-6 font-semibold text-sm hover:bg-muted transition">
