      ...
      <div className="container mx-auto px-4">
        <div className="rounded-3xl bg-primary p-10 sm:p-14 text-primary-foreground relative overflow-hidden">
          ...
          <div className="relative grid md:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div className="z-10">
              <div className="inline-flex items-center border border-transparent px-2.5 py-0.5 text-xs font-semibold bg-accent text-accent-foreground rounded-full mb-4">
                Built for mobile
              </div>

              <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4 text-balance leading-tight">
              ...
              <a href="/templates" className="inline-block">
            ...
            {/* Right Visuals (Dashboard UI Stack) */}
            <div className="relative h-[300px] sm:h-[400px] flex items-center justify-center">
              {/* Main "Editor" Window */}
              <div className="absolute w-full max-w-[320px] sm:max-w-[380px] bg-card rounded-2xl shadow-2xl border border-border overflow-hidden transform -rotate-2">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="h-20 rounded-xl bg-muted/50 border border-dashed border-border flex flex-col items-center justify-center gap-2">
              ...
              <div className="absolute top-10 right-0 sm:-right-4 w-48 sm:w-56 bg-card rounded-xl shadow-2xl border border-primary/20 p-4 transform rotate-6 animate-float z-20">
              ...
              <div className="absolute bottom-12 left-1/4 z-30 animate-pulse">
                <MousePointer2 className="h-6 w-6 text-secondary fill-secondary drop-shadow-md" />
              </div>

              {/* Floating Element: Sparkles */}
              <div className="absolute -top-4 left-10 text-accent animate-pulse">
...
export default MobileReadySection;
